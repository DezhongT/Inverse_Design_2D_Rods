...
Kap0_base, natural_config_base, BCs = compute_theory(Config, eta, qx_func, qy_func, degree=degree)
pred_config_base = forward_solver(Kap0_base, Config[:, 0], eta,  BCs, qx_func, qy_func)

Kap0_noise, natural_config_noise, BCs = compute_theory(Config_noise, eta, qx_func, qy_func, degree = degree)
...
plt.scatter(Config_noise[:, 1], Config_noise[:, 2] , label = "Noisy shape")
