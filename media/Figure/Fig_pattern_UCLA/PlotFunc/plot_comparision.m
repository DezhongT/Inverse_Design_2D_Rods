...
surf(X, Y, Z, 'FaceColor', mycolor(1,:), 'EdgeColor', 'none', 'FaceAlpha', 0.5);

interval = 1;
df = importdata('../LetterU_eta_15.mat');
...
light('Position', [0 0 2.0], 'Style', 'local', 'Color', [0.5, 0.5, 0.5]);  % Light source in positive z-axis
...
exportgraphics(h, '13.pdf','Resolution',600)
